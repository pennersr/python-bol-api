...
def test_orders():
    with HTTMock(orders_stub):
        ...
        assert order.CustomerDetails.BillingDetails.Streetname == "Billingstraat"
        ...
        assert order.CustomerDetails.BillingDetails.DeliveryPhoneNumber == "67890"
        ...
        assert order.CustomerDetails.ShipmentDetails.Streetname == "Shipmentstraat"
        assert order.CustomerDetails.ShipmentDetails.Housenumber == "42"
        assert order.CustomerDetails.ShipmentDetails.HousenumberExtended == "bis"

        assert (
            order.CustomerDetails.ShipmentDetails.AddressSupplement == "3 hoog achter"
        )
        ...
        assert order.CustomerDetails.ShipmentDetails.Email == "nospam4me@myaccount.com"
        assert order.CustomerDetails.ShipmentDetails.DeliveryPhoneNumber == "12345"
